                ...
                <div className='m-auto flex flex-col py-10'>
                    <section className='flex gap-20 w-[100%] h-[100%] border-black'>
                        <ul className='flex flex-col gap-2'>
                            <h5 className='text-[16px] mb-1 uppercase tracking-widest font-bold'> Development</h5>
                        ...
                        <ul className='flex flex-col gap-2'>
                            <h5 className='text-[16px] mb-1 uppercase tracking-widest font-bold'>Institution</h5>
                            <li className='font-CourierPrime text-xs'>
                                <a
                                    href="https://women.acm.org/"
                                    target="_blank"
