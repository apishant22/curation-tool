...
const AuthorHighlight = ({ authorDetails }) => {
  ...
  const getBorderStyle = (index) =>
    ["border-yellow-400", "border-gray-300", "border-orange-600"][index] ||
    "border-gray-300";

  return (
    <div className="bg-gradient-to-br from-gray-100 via-gray-200 to-gray-300 text-black min-h-screen flex justify-center items-center p-10 pt-32">
