            ...
            {data ? (
              <>
                {[
                  ...
                  .filter(
                    (recommendation) => recommendation.Authors?.length > 0
                  )
                  .map((recommendation, sectionIndex) => (
                    <div
                      key={sectionIndex}
                      className="w-full group relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                              ...
                              (
                                ...
                                <div
                                  ...
                                  <ContentCard
                                    ...
                                    reason={
                                      author.Reason || "No reason provided."
                                    }
                                  />
                                </div>
                              )
