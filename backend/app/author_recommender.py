...
if __name__ == "__main__":
    ...
    results = asyncio.run(get_acm_recommendations_and_field_authors(context, authors, max_recommendations=5, max_results_per_field=5))

    print("Part 1 (Default Fields)")
    print(results)

    results1 = asyncio.run(get_acm_recommendations_and_field_authors(context, authors, max_recommendations=5, max_results_per_field=5))
